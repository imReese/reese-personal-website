...
import TypingAnimation from "@/components/ui/typing_animatgion"
import { ThemeToggle } from "@/components/shared/theme_toggle"
import { GithubRepo } from "@/components/shared/github_repo"
...
export function Header() {
  ...
  return (
    <>
      <header
        className="pointer-events-none relative z-50 flex-none flex-col"
        style={{
              ...
              >
                <div className="relative">
                  ...
                  <div className="flex flex-row items-center gap-4">
                    ...
                    />
                    <div
                      className="text-3xl md:text-6xl font-bold tracking-light flex flex-row"
                      style={{
                        transform: "var(--avatar-text-transform)",
                      }}
                    >
                      Hi,{" "}
                      <TypingAnimation
                        className="text-3xl md:text-6xl font-bold tracking-light"
                        text={`I"m ${name} `}
                        duration={150}
                      />
                      👋
          ...
          >
            <div className="relative flex gap-4">
              ...
              <div className="flex flex-1 justify-end md:justify-center">
                ...
                <DesktopNavigation className="pointer-events-auto md:hidden" />
              </div>
